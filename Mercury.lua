...
function UpdateTime()  
    ...
    if Date.Hour > 12 or Date.Hour == 0 then
        DisplayTime = DisplayHour - 12 .. ":" .. DisplayMinute.. " am, ".. DisplayDay..", "..DisplayMonth.." ".. DisplayDay2 .. ", " .. DisplayYear
    else
...
function Library:change_theme(toTheme)
    ...
    Library.DisplayName.Text = greeting.."<font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>"
...
function Library:create(options)
	...
	local displayName; do
		...
		local displayName = profile:object("TextLabel", {
			RichText = true,
			Text = greeting.."<font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>",
			TextScaled = true,
	...
	creditsTab:credit{Name = "Im_Sa7urn", Description = "Project Saturn Owner", Discord = "ewitscaydon"}
